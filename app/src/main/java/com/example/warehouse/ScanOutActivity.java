                ...
                runOnUiThread(new Runnable()
                {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            final String comments = arr[7];// displays toast, displaying name, helping user know that the item scanned it correct
                            myApiEndpointInterface.deleteMaterial(name).enqueue(new Callback<APIResponse>() {
                                @Override
                                public void onResponse(Call<APIResponse> call, Response<APIResponse> response) {
                                    Toast.makeText(ScanOutActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                                }
...
//                                            Toast.makeText(ScanOutActivity.this, "Item Removed!", Toast.LENGTH_SHORT).show();
//                                        }
//                                        else
//                                        {
//                                            Toast.makeText(ScanOutActivity.this, "Item Not Found!", Toast.LENGTH_SHORT).show();
//                                        }
//                                    }
//                                }
//                                @Override
...
//                            re.addListenerForSingleValueEvent(eventLister); // will allow for the event to occur
                        ...
                        {
                            Toast.makeText(ScanOutActivity.this, "QR code not found!", Toast.LENGTH_SHORT).show();  // displays toast, displaying name, helping user know that the item scanned it correct
                        }
    ...
    {
        startActivity(new Intent(getApplicationContext(), Inventory2Activity.class));
    }
