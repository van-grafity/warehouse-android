 ...
 */
public class PriceQuantityActivity extends AppCompatActivity {
                ...
                runOnUiThread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        try {
                            ...
                            Toast.makeText(PriceQuantityActivity.this, name.toLowerCase() + " - " + color.toLowerCase(), Toast.LENGTH_SHORT).show();  // displays toast, displaying name, helping user know that the item scanned it correct
                            ...
                            reff.child(name.toLowerCase()).child(color.toLowerCase()).child(condition.toLowerCase()).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    try {
                                        ...
                                        Toast.makeText(PriceQuantityActivity.this, "QR code not found!", Toast.LENGTH_SHORT).show();  // displays toast, displaying name, helping user know that the item scanned it correct
                                    }
                                }
                                @Override
