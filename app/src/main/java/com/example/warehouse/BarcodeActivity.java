...
public class BarcodeActivity extends AppCompatActivity {
	...
	**/
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(BarcodeActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
        ActivityCompat.requestPermissions(BarcodeActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},1);

        // Receive the data(name of item) from AddItem class
        Intent intent = getIntent();
        String newName = intent.getStringExtra(AddItemActivity.MESSAGE);
        Log.i(TAG, "onCreate: "+newName);
